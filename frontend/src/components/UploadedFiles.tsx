...
// const UploadedFiles: React.FC<UploadedFilesProps> = ({ uploadedFiles, removeFile, formatFileSize }) => (
...
//             <div key={file.id} className={`group p-3 rounded-lg border ${getStatusColor(file.status)} hover:shadow-sm transition-shadow`}>
